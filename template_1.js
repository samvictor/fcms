...
html(lang="en")
    ...
    body
        // ======================================= BODY ======================================
        div( id="tab_bar" )
        a( href="/fcms" class="no_underline" )
            h1( id="site_title" )
        a( href="/fcms" class="no_underline" )
            img( id="header_image" )
        div( id="paper")
    ...
    script.
        ...
        firebase.database().ref('/scms_data/info_page_content').once('value', function(snapshot){
                ...
                console.log('first draw replace state');
                ...
                case 'page': 
                    ...
                    firebase.database().ref('/scms_data/info_page_content/page_content').once('value', function(snapshot){
                        ...
                        data.forEach(function(page){
                            ...
                            if (push_state) {
                                history.replaceState({'page_data': page_data, 'new_url': new_url}, page_data['page_title'], page_data['root']+new_url);
                                
                                console.log("do_assign replace state. push_state is", push_state);
                            }
